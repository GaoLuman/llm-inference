...
|Qwen3.5-2B|fp16|2.2GB|1133.89|210.06|323.89|4.92|6.17|7.40|40.39|

虽然张量并行的Prefill计算理论上分到多卡后更快，但是由于TP需要多次通信，增加了通信开销，反而导致TTFT变大。同理，ITL的时间由于通信等待时间而变大了。  
但是由于降低了单卡计算量，支持更大的batch_size，更快完成batch运算，吞吐量还是变大了。  
